...
function renderOS(data, messages) {
...
function renderInvalidLinuxVariant(data, messages) {
    const { machineData: mD } = data;
...
function renderValidLinuxVariant(data, messages) {
    const { machineData: mD, machineValidation: mV } = data;
...
function renderLinuxCPUModel(data, messages) {
    const { machineData: mD } = data;
    messages.info.push({
...
function renderMacOSVersion(data, messages) {
    const { machineData: mD, machineValidation: mV } = data;
    if (mV.isValidOSVersion) {
        messages.info.push({
...
function renderMacCPUType(data, messages) {
    const { machineData: mD, machineValidation: mV } = data;
...
function renderRAM(data, messages) {
    const { machineData: mD, machineValidation: mV } = data;
    if (mV.isRecRAM) {
        messages.info.push({
...
function renderHomedirUsername(data, messages) {
    const { machineData: mD } = data;
    messages.info.push({
